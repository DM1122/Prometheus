...
params = [learn_rate_space, layers_space, nodes_space, act_space, droprate_space, batch_space]
params_init = [1e-3, 1, 8, 'relu', 0.0, 128]
#endregion
...
def fitness(learn_rate, n_layers, n_nodes, act, droprate, batch_size):
...
if __name__ == '__main__':
    ...
    #region Plots
    fig1, fig2, fig3 = figurelib.plot_opt(search=params_search, dims=['learn_rate', 'n_layers', 'n_nodes', 'droprate', 'batch_size'])
